...
CREATE TABLE public.chapters (
    ...
    paper_type text DEFAULT 'question'::text NOT NULL,
...
--
-- Name: user_downloads user_downloads_chapter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_downloads
    ADD CONSTRAINT user_downloads_chapter_id_fkey FOREIGN KEY (chapter_id) REFERENCES public.chapters(id) ON DELETE CASCADE;
...
--
-- Name: user_downloads Admins can view all downloads; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can view all downloads" ON public.user_downloads FOR SELECT USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Users can insert their own downloads" ON public.user_downloads FOR INSERT WITH CHECK (true);
